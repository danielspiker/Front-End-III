...
import { LojaNewGames } from '../../components/LojaNewGames'
import { LojaHalloween } from '../../components/LojaHalloween'
  ...
  return (
    <div className="container">
      ...
      <section className="new-games-section">
        <h1 className="section-title">New Games</h1>
        {newGames.map(game => (
          <LojaNewGames item={game} />
        ))}
      </section>
      <section className="halloween-games-section">
        <h1 className="section-title">Halloween Offers</h1>
        <div className="game-cards">
          {halloweenGames.map(game => (
            <LojaHalloween item={game} />
          ))}
        </div>
      </section>
    </div>
